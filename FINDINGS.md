...
- **[CAND-E] MUSDB «educational purposes only» vs shipped templates.** Τα w_music/w_speech μαθαίνονται από MUSDB και σαλάρουν στο binary εμπορικού προϊόντος (weights-as-derivative γκρίζα ζώνη). Επιλογές: clean-room retrain (CC0/CC-BY/ιδίες ηχογραφήσεις) / permission request / IP counsel. Το factory κάνει το retrain φθηνό. Trigger: LAUNCH GATE πριν 30/09. (Και: Saraga NC = ποτέ training · am_contra fixture σε τυχόν μελλοντικό public repo = ίδιο checklist.)
