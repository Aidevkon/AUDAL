...
- **[F-098] Ο βρόχος διόρθωσης φάσματος μετράει σε ολοκληρωμένες μπάντες
  ...
  **Το Q δεν είναι πύλη.** Ο B μετριέται για όποιο Q: `cond = 10.67` στο
  ...
  ΤΕΚΜΗΡΙΟ: `scratchpad/bmat/` (πίνακας B, γραμμικότητα) ·
  `scratchpad/ltass3/` (τέσσερις διαμορφώσεις) — εφήμερα. Τα νούμερα είναι
  εδώ, και το harness αναπαράγεται από την περιγραφή του οργάνου.
