use super::predictive::{MarkovDelta, InstrumentDelta};
...
pub const DRUMS_BOUNDS: InstrumentBounds = InstrumentBounds { level_max_db: 3.0, eq_max_db: 2.0, attack_max_ms: 10.0 };
pub const BASS_BOUNDS: InstrumentBounds = InstrumentBounds { level_max_db: 2.0, eq_max_db: 1.5, attack_max_ms: 5.0 };
pub const HARMONICS_AMBIENCE_BOUNDS: InstrumentBounds = InstrumentBounds { level_max_db: 4.0, eq_max_db: 3.0, attack_max_ms: 15.0 };
