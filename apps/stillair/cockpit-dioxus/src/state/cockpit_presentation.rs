...
mod tests {
    ...
    fn tier_labels_correct() {
        assert_eq!(
            CockpitPresentation::from_tier(CockpitTier::Tier1_BlackBox).tier_label,
            "BLACK BOX"
        );
        assert_eq!(
            CockpitPresentation::from_tier(CockpitTier::Tier2_Medium).tier_label,
            "MEDIUM"
        );
        assert_eq!(
            CockpitPresentation::from_tier(CockpitTier::Tier3_Pro).tier_label,
            "PRO"
        );
    }
}
