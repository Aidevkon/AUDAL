...
pub const PLATFORMS: &[PlatformDef] = &[
    PlatformDef { id: "spotify",       label: "Spotify / Apple", lufs: -14.0 },
    PlatformDef { id: "apple_podcast", label: "Podcast",         lufs: -16.0 },
    PlatformDef { id: "broadcast",     label: "Broadcast",       lufs: -23.0 },
    PlatformDef { id: "youtube",       label: "YouTube",         lufs: -14.0 },
];
