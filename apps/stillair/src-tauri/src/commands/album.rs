...
#[tauri::command]
pub async fn subscribe_album_events(
    batch_id: String,
    app: AppHandle,
) -> Result<(), String> {
    tauri::async_runtime::spawn(async move {
        ...
        let url = format!(
            "http://127.0.0.1:7402/album/{batch_id}/events/stream"
        );
                ...
                Ok(Event::Message(msg)) => {
                        ...
                        serde_json::from_str::<serde_json::Value>(&msg.data)
                    {
                        ...
                        if event_type == "fatigue" {
                            ...
                            let prev = val["prev_lufs"]
                                .as_f64()
                                .unwrap_or(-14.0);
                            let duck = val["ducking"]
                                .as_f64()
                                .unwrap_or(1.0);
                            let width = val["width"]
                                .as_f64()
                            ...
                            let _ = app.emit("jini://album_fatigue",
                                             &jini_payload);
                        }
                    }
                }
