...
ΜΟΡΦΗ ΔΙΟΡΘΩΣΗΣ (εγκεκριμένη, ανεκτέλεστη): profile ως
ΤΙΜΗ ("acx-audiobook" + source + retrieved_date) στο κεφάλι,
πεδία ουδέτερα (delivery_rms_db κ.λπ.) ΜΕ ΡΗΤΟ ΟΡΙΣΜΟ
ανά μετρική — ουδέτερο όνομα ΧΩΡΙΣ τον ορισμό κρύβει
ποιος ορισμός χρησιμοποιήθηκε (λύνει την ταμπέλα,
ανοίγει χειρότερο).
