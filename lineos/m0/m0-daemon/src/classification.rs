...
pub fn guess_content_type(
    ...
    let sub_bass_energy_db = pre.spectral_profile_db[0];
    let mid_energy_db = pre.spectral_profile_db[4];
    let signals = GuessSignals {
        crest_factor_db: pre.global_crest_factor_db,
        loudness_range: pre.loudness_range,
        sub_bass_energy_db,
        mid_energy_db,
        duration_secs,
        file_count,
...
mod tests {
    ...
    fn synthetic_pre_analysis(
        ...
        PreAnalysisData {
            ...
            global_crest_factor_db: crest_db,
    ...
    fn clean_speech_profile_guesses_speech_with_high_confidence() {
        ...
        let pre = synthetic_pre_analysis(18.0, 15.0, -40.0, -12.0);
        let result = guess_content_type(&pre, 1800.0, 1);
    ...
    fn dense_mastered_music_profile_guesses_music_with_high_confidence() {
        ...
        let pre = synthetic_pre_analysis(7.0, 5.0, -8.0, -10.0);
        let result = guess_content_type(&pre, 210.0, 1);
    ...
    fn ambiguous_profile_yields_uncertain_not_a_forced_guess() {
        ...
        let pre = synthetic_pre_analysis(16.0, 6.0, -9.0, -10.0);
        let result = guess_content_type(&pre, 240.0, 1);
