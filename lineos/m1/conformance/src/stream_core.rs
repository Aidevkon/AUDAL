...
use crate::signal_health::SignalHealthMonitor;
...
pub struct StandardizedStreamCore<const N: usize> {
    pub reader: crate::lazy_reader::LazyAudioReader,
...
impl<const N: usize> StandardizedStreamCore<N> {
    pub fn new(
        reader: crate::lazy_reader::LazyAudioReader,
...
mod tests {
    ...
    fn f047_regression_guard_flush_drains_multiple_blocks() {
        ...
        let reader =
            crate::lazy_reader::LazyAudioReader::open(std::path::Path::new(path)).unwrap();
    ...
    fn test_tap_equals_output() {
        ...
        let mut stream = crate::standardized_stream::StandardizedAudioStream::open(
