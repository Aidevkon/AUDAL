...
pub struct StateFeatures {
    ...
    /// 13 MFCC coefficients — timbral fingerprint of this window.
    /// Captures what rms/centroid/flatness cannot: voice vs bass vs kick.
    /// [0.0; 13] when MFCCs not computed (corpus reader path).
    pub mfcc: [f32; 13],
}
