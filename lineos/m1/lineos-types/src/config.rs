...
impl LoudnessTarget {
    pub fn spotify() -> Self {
        Self { target_lufs: -14.0, max_true_peak_db: -1.0, max_lra_lu: None, platform: "spotify".into() }
    }
    pub fn youtube() -> Self {
        Self { target_lufs: -14.0, max_true_peak_db: -1.0, max_lra_lu: None, platform: "youtube".into() }
    }
    pub fn broadcast() -> Self {
        Self { target_lufs: -23.0, max_true_peak_db: -1.0, max_lra_lu: Some(20.0), platform: "broadcast".into() }
    }
    pub fn podcast() -> Self {
        Self { target_lufs: -16.0, max_true_peak_db: -1.0, max_lra_lu: None, platform: "podcast".into() }
    }
}
